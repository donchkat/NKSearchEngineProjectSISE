...
for blob in client.list_blobs(bucket_name, prefix='postings_gcp/titles_index_files'):
    if not blob.name.endswith("index_titles.pkl"):
        continue
...
def search_title_answer_backend(curr_query):
  relevant_words = []
  ps = []
